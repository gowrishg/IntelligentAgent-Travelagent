...
public class CustomerUi extends javax.swing.JFrame {
               ...
               Runnable rRunnable = new Runnable(){
                   public void run(){
                       try {
                           ...
                           while((TravelAgent.flightDetailList.isEmpty()) && retryCnt <=5){
                       ...
                       SwingUtilities.invokeLater(new Runnable(){
                           public void run(){
                               ...
                               jlBusy.setVisible(false);
                               if (TravelAgent.flightDetailList.isEmpty()){
                   ...
                   public void run(){
                       try {
                           ...
                           while(travelAgent.hotelDetailList.isEmpty() && retryCnt <=5){
                               Thread.sleep(sleepDuration);
                               retryCnt = retryCnt + 1;
                               System.out.println("Enter:" + retryCnt);
                           }
                       ...
                       SwingUtilities.invokeLater(new Runnable(){
                           public void run(){
                               jlBusy.setVisible(false);
                               if (travelAgent.hotelDetailList.isEmpty()){
                                    JOptionPane.showMessageDialog(CustomerUi.this, "Sorry no matching hotels!!!", "Information", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void populateBooking(){
        ...
        if(TravelAgent.PaymentStatus.equals("payment-success"))
        {
            ...
            jTextArea1.append(", Number of rooms booked: " + guestCount.getSelectedItem() + "\n");
            jTextArea1.append("------------------------------------------------------ \n");
            jTextArea1.append("\n");
